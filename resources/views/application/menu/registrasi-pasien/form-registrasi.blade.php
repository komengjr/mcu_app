<div class="modal-body p-0">
    ...
    <div class="p-4">
        <form id="form-add-pasien" class="row g-3" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                <label class="form-label" for="inputAddress">Nama Kurir</label>
                <input class="form-control" id="inputAddress" type="text" name="kurir" placeholder="Ex Ahmad Shobirin"
                    required />
            </div>
            <div class="col-md-12">
                <label class="form-label" for="inputAddress">Pilih Perujuk</label>
