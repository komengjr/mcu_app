                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-8 mt-0">
                                                    <div class="card p-3 my-2 border border-danger">
                                                        {{-- <h6 class="fw-semi-bold ls text-uppercase">Informasi Perusahaan
                                                        </h6> --}}
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <a href="#" id="button-sudah-mcu"
                                                                    ...
                                                                    data-bs-toggle="modal" data-bs-target="#modal-monitoring">
                                                                    <h5 class="fs--1 fs-md-1 text-warning mb-0">
                                                                        {{ $totalmcu }}
                                                                        Peserta
                                                                    </h5>
            ...
            <div class="modal-content border-0">
                <div class="position-absolute top-0 end-0 mt-3 me-3 z-index-1">
                    <button class="btn-close btn btn-sm btn-circle d-flex flex-center transition-base"
                        data-bs-dismiss="modal" id="close-modal-monitoring" aria-label="Close"></button>
                </div>
