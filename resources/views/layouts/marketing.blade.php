                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><img class="me-2" src="{{ asset('img/pram.png') }}"
                                alt="" width="145" /><span class="font-sans-serif fs-2 text-youtube"></span>
                        </div>
                    </a>
                </div>
                ...
                <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="#">
                        <div class="d-flex align-items-center"><img class="me-2" src="{{ asset('img/pram.png') }}"
                                alt="" width="180" /><span class="font-sans-serif text-youtube"></span>
                        </div>
                    </a>
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">Thank you for creating with Innoventra<span
                                    class="d-none d-sm-inline-block">| </span><br class="d-sm-none" /> 2025 &copy;
                                <a href="#">Marketing System</a>
