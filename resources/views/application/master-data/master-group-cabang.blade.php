            ...
            <div class="card bg-200 shadow border border-danger">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-danger fw-bold mb-0">Master <span class="text-danger fw-medium">User Cabang</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-danger">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-danger m-0 p-0">Master User Cabang</span></h3>
                </div>
                <div class="col-auto">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-user"
                                id="button-add-group" data-code="123"><span class="far fa-edit"></span>
                                Tambah Group</button>
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-add-group", function(e) {
            e.preventDefault();
