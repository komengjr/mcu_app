                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-user"
                                id="button-add-menu" data-code="123"><span class="far fa-edit"></span>
                                Tambah Menu</button>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-master"
                                            id="button-master-staff" data-code="123"><i class="fas fa-download"></i></span>
                                            Edit Menu</button>
                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-master"
                                            id="button-master-staff" data-code="123"><i class="fas fa-trash"></i>
                                            Hapus Menu</button>
                                    </div>
                                </div>
                            </td>
