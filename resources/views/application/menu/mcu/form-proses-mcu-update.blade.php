        ...
        <div class="card border border-primary" id="menu-absensi-kehadiran">
            <form class="row g-3 p-4" action="{{ route('medical_check_up_prosess_update_save') }}" method="post"
                ...
                <div class="col-12 pt-3">
                    <button class="btn btn-dark btn-sm" id="button-generate-barcode-kehadiran"
                        data-code="{{ $data->mou_peserta_code }}"><span class="far fa-chart-bar"></span> Generate
                        Barcode Kehadiran</button>
