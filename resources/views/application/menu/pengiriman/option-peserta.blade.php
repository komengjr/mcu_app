 <div class="col" style="z-index: 999;">
     ...
     <select class="form-select js-choice-peserta" id="pesertamcu" multiple="multiple" name="organizerMultiple" data-options='{"removeItemButton":true,"placeholder":true}' style="z-index: 999;">
